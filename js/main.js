...
function CreateCard(trainer)
{
    var cardTemplate = [
        ...
        trainer.url,
        '" >',
        '<div style="width :130px"><img class="coverholder m-1 rounded lazy" onerror="if (this.src !== \'./images/error.png\') this.src = \'./images/error.png\';" data-src="./files/',
        trainer.title,
...
function TrainerClickCallback()
{
    ...
    $("#cover").attr('data-src', "./files/" + cusa + ".jpg");
